...
fun main(){
    ...
    //4 Overloading arithmetic operators (times operator)
    val p = Point(10, 20)
    ...
    //10 Accessing elements by index: “get” and “set”
    //Implementing the get convention
    val dot1 = Point(10,20)
    println(dot1[1])
    println(dot1)

    //11 Accessing elements by index: “get” and “set”
...
//11 Implementing the get convention
